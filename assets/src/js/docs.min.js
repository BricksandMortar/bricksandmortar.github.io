...
function setupCoverChevron() {
    ...
    if (!(isMobile.matches)) {
        ...
        $('#chevron-down').click(function () {
            $(window).scrollTo(document.getElementById("content-top"), 100).delay(700);
...
$(function() {
    $.getJSON('https://api.fixer.io/latest?base=GBP&symbols=USD&callback=?')
        .done(function(data) {
            $('#usd-rate').text((parseInt($('#gbp-rate').text()) * data.rates.USD).toFixed(2))
        });
});
